...
from models.utils import MLP, VirtualNode, CentralityEncoder, DropEdge, set_seed, warmup_lr
...
# SINC-GCN model architecture following EGC
class SINCModel(nn.Module):
    def __init__(self, hidden_dim, output_dim, num_layers=1, input_dropout=0, edge_dropout=0, dropout=0, norm='none', 
                 ...
                 residual=False, resid_layers=0, resid_dropout=0, feat_dropout=0, agg_type='sum', neigh_agg_type='sum', **kwargs):
