...
from models.utils import MLP, DropEdge, set_seed, warmup_lr
...
class SINCModel(nn.Module):
    def __init__(self, input_dim, edge_dim, hidden_dim, output_dim, num_layers=1, input_dropout=0, edge_dropout=0, dropout=0, norm='none', 
        ...
        for i in range(num_layers):
            ...
            self.convs.append(SINCConv(_input_dim, hidden_dim, hidden_dim, self.activation, feat_dropout, agg_type=agg_type, neigh_agg_type=neigh_agg_type))
